  ...
  },
  {
    ...
    a: (
      <>
        ...
        Calendar. Sending through a connected app is different: a Gmail
        email or a Slack message going to someone else is always held and
        always asks you, even if you have turned everything else off.
